...
module.exports = {
    ...
    create: function(context) {
        ...
        function isCommentAtParentStart(node, nodeType) {
            var parent = lodash.last(context.getAncestors());
            console.log("\n\n\n\n\nPARANETNTS ! ", parent)
            console.log("Parenttokens", parent.parent.tokens)
        ...
        function isCommentAtBlockStart(node) {
            return isCommentAtParentStart(node, "ClassBody")
                || isCommentAtParentStart(node, "BlockStatement")
                || isCommentAtParentStart(node, "FunctionDeclaration")
                || isCommentAtParentStart(node, "SwitchCase");
        }
        ...
        function isCommentAtBlockEnd(node) {
            return isCommentAtParentEnd(node, "ClassBody")
                || isCommentAtParentEnd(node, "BlockStatement")
                || isCommentAtParentEnd(node, "FunctionDeclaration")
                || isCommentAtParentEnd(node, "SwitchCase")
                || isCommentAtParentEnd(node, "SwitchStatement");
        }
...
// console.log(options)
console.log(isCommentAtBlockStart(node));
console.log(blockStartAllowed, objectStartAllowed, arrayStartAllowed, exceptionStartAllowed);
